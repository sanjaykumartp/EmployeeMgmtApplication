...
//						System.out.println("Date of Birth Updated Sucesfull");
				...
				configurationd.configure("hibernate.cfg.xml");
				configurationd.addAnnotatedClass(Department.class);

				//Creating Session Factory
				SessionFactory sessionFactoryd = configurationd.buildSessionFactory();
